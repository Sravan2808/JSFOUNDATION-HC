/*
 1.Write a for loop that loop through the array
 ["green tea","black tea","chai","oonlong"] and 
 stops the loop when it finds "chai"/
 Store all teas before "chai" in a new array named
 'selectedTeas'.
*/

let teas  = ["green tea","black tea","chai","oonlong"];
let selectedTeas = [];
...
/* 
2.Write a for loop that loop through the array
["London","NewYork","Paris","Berlin"] and skips 
"Paris"
...
Stop the loop when the popuulation of "Berlin"  is
found and store all previous cities' populations in a 
new object named 'ciityPopulations'.
...
the result in a new array named 'doubledNumbers'.
*/
